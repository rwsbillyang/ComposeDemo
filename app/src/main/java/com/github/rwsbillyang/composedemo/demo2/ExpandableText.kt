...
//https://github.com/TheMelody/ComposeTextEffect/blob/main/app/src/main/java/com/melody/text/effect/components/ExpandableText.kt
...
private  val SizeValueSaver = listSaver<Size, Float>(
    save = { listOf(it.width, it.height) },
    restore = { Size(it[0], it[1]) }
)

private val OffsetValueSaver = listSaver<Offset, Float>(
